...
array_exe_sce_0=('a26.out' 'a27.out' 'a28.out'  'a29.out' 'a210.out' 'a211.out' 'a212.out')
...
array_cases=('6th' '7th' '8th' '9th' '10th' '11th' '12th' )
